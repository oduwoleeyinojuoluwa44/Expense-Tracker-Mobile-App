import { AllocationGraphSection } from '@/features/insights/components/allocation-graph-section';
import { SpendingVelocityCard } from '@/features/budget/components/spending-velocity-card';
import { FinancialInsightsSection, type InsightsTimeTab } from '@/features/insights/components/financial-insights-section';
import { MonthlyOverviewSection } from '@/features/insights/components/monthly-overview-section';
import { SmartAllocationGoalCard } from '@/features/insights/components/smart-allocation-goal-card';
import { SmartSuggestionsSection } from '@/features/insights/components/smart-suggestions-section';
